  ...
  const resp = await fetchWithTimeout(
    url,
    {
      headers: {
        ...
        // Some SearXNG instances (and the upstream engines they fan out
        // to) bot-block requests with no/blank User-Agent, returning a
        // 403 instead of results — a plain browser-style UA avoids that.
        "User-Agent":
